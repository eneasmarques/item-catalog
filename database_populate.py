...
menuItem2 = MenuItem(name="Veggie Burger", description="Juicy grilled veggie patty with tomato mayo and lettuce",
                     price="$7.50", course="Entree", restaurant=restaurant1, user=user)
...
menuItem1 = MenuItem(name="Chicken Stir Fry", description="With your choice of noodles vegetables and sauces",
                     price="$7.99", course="Entree", restaurant=restaurant2, user=user)
...
# restaurant1 = Restaurant(user=user, name="Panda Garden")
...
#                      price="$8.99", course="Entree", restaurant=restaurant1, user=user)
...
#                      price="$6.99", course="Appetizer", restaurant=restaurant1, user=user)
...
#                      price="$9.95", course="Entree", restaurant=restaurant1, user=user)

# session.add(menuItem3)
# session.commit()

# menuItem4 = MenuItem(name="Stinky Tofu", description="Taiwanese dish, deep fried fermented tofu served with pickled cabbage.",
#                      price="$6.99", course="Entree", restaurant=restaurant1, user=user)

# session.add(menuItem4)
# session.commit()

# menuItem2 = MenuItem(name="Veggie Burger", description="Juicy grilled veggie patty with tomato mayo and lettuce",
#                      price="$9.50", course="Entree", restaurant=restaurant1, user=user)
...
# restaurant1 = Restaurant(user=user, name="Thyme for That Vegetarian Cuisine ")
...
#                      price="$2.99", course="Dessert", restaurant=restaurant1, user=user)
...
#                      price="$4.50", course="Dessert", restaurant=restaurant1, user=user)
...
#                      price="$6.95", course="Appetizer", restaurant=restaurant1, user=user)
...
#                      price="$7.95", course="Entree", restaurant=restaurant1, user=user)

# session.add(menuItem5)
# session.commit()

# menuItem2 = MenuItem(name="Veggie Burger", description="Juicy grilled veggie patty with tomato mayo and lettuce",
#                      price="$6.80", course="Entree", restaurant=restaurant1, user=user)
...
# restaurant1 = Restaurant(user=user, name="Tony\'s Bistro ")
...
#                      price="$13.95", course="Entree", restaurant=restaurant1, user=user)

# session.add(menuItem1)
# session.commit()

# menuItem2 = MenuItem(name="Chicken and Rice", description="Chicken... and rice",
#                      price="$4.95", course="Entree", restaurant=restaurant1, user=user)

# session.add(menuItem2)
# session.commit()

# menuItem3 = MenuItem(name="Mom's Spaghetti", description="Spaghetti with some incredible tomato sauce made by mom",
#                      price="$6.95", course="Entree", restaurant=restaurant1, user=user)

# session.add(menuItem3)
# session.commit()

# menuItem4 = MenuItem(name="Choc Full O\' Mint (Smitten\'s Fresh Mint Chip ice cream)",
#                      description="Milk, cream, salt, ..., Liquid nitrogen magic", price="$3.95", course="Dessert", restaurant=restaurant1, user=user)
...
# # Menu for Andala's
# restaurant1 = Restaurant(user=user, name="Andala\'s")
...
#                      price="$6.50", course="Appetizer", restaurant=restaurant1, user=user)

# session.add(menuItem3)
# session.commit()

# menuItem4 = MenuItem(name="Nigiri Sampler", description="Maguro, Sake, Hamachi, Unagi, Uni, TORO!",
#                      price="$6.75", course="Appetizer", restaurant=restaurant1, user=user)

# session.add(menuItem4)
# session.commit()

# menuItem2 = MenuItem(name="Veggie Burger", description="Juicy grilled veggie patty with tomato mayo and lettuce",
#                      price="$7.00", course="Entree", restaurant=restaurant1, user=user)
...
# restaurant1 = Restaurant(user=user, name="Auntie Ann\'s Diner' ")
...
#                      price="$10.95", course="Entree", restaurant=restaurant1, user=user)
...
#                      price="$7.50", course="Appetizer", restaurant=restaurant1, user=user)
...
#                      price="$8.95", course="Entree", restaurant=restaurant1, user=user)
...
#                       price="$1.99", course="Dessert", restaurant=restaurant1, user=user)
...
# restaurant1 = Restaurant(user=user, name="Cocina Y Amor ")
...
#                      price="$5.95", course="Entree", restaurant=restaurant1, user=user)
...
# restaurant1 = Restaurant(user=user, name="State Bird Provisions")
# session.add(restaurant1)
# session.commit()
...
#                      price="$5.95", course="Appetizer", restaurant=restaurant1, user=user)
...
#                      price="$6.95", course="Dessert", restaurant=restaurant1, user=user)
...
#                      price="$4.25", course="Dessert", restaurant=restaurant1, user=user)
